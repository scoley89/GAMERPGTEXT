let state = {};
const gender = state.isMale ? "Mr. " : "Ms. ";
...
const textNodes = function() {
  return [
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedArmy: true, isInfantry: true },
          nextText: 105
        },
        {
          text:
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedArmy: true, isTankCommander: true },
          nextText: 1000
        },
        {
          text:
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedArmy: true, isFieldMed: true },
          nextText: 106
        }
      ]
    },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedNavy: true, isCook: true },
          nextText: 103
        },
        {
          text:
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedNavy: true, isNLE: true },
        ...
        },
        {
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedNavy: true, isSMC: true },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedAirForce: true, isDogFighter: true },
          nextText: 107
        },
        {
          text: "...usually freeze. I never was the brighest bulb.",
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedAirForce: true, isTailGunner: true },
          nextText: 108
        ...
        // reset goes after next iteration of this branch of the story________GAME OVER OPTION______________
        {
          ...
          requiredState: currentState => currentState.isMale,
          setState: { isMale: true, joinedAirForce: true, isEng: true },
          nextText: 10
        }
      ]
    },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isFemale,
          setState: { isFemale: true, joinedArmy: true, isWAC: true },
        ...
        },
        {
          ...
          requiredState: currentState => currentState.isFemale,
          setState: { isFemale: true, joinedArmy: true, isArmyIntel: true },
          nextText: 101
        },
        {
          text:
          ...
          requiredState: currentState => currentState.isFemale,
          setState: { isFemale: true, joinedArmy: true, isFeildMed: true },
          nextText: 894723058927
        }
      ]
    },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isFemale,
          setState: { isFemale: true, joinedAirForce: true, isWAF: true },
          nextText: 24982759298
        },
        {
          text:
        ...
        // reset goes after the next iteration of this part of the story
        {
          ...
          requiredState: currentState => currentState.isFemale,
          setState: { isFemale: true, joinedAirForce: true, isEng: true },
          nextText: 11
        }
      ]
    },
    ...
    // currentState.isMale.isArmy
    // currentState = {ismale {isarmy {isisInfantry}}}
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isInfantry,
          setState: { isMale: true, joinedArmy: true, isInfantry: true },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.joinedArmy,
          setState: { isMale: true, joinedArmy: true, isFeildMed: true },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.joinedAirForce,
          setState: { isMale: true, joinedAirForce: true, isDogFighter: true },
          nextText: 109
        },
        {
        ...
        },
        {
          ...
          requiredState: currentState => currentState.joinedAirForce,
          setState: { isMale: true, joinedAirForce: true, isDogFighte: true },
          nextText: 894723058927
        }
      ]
    },
      ...
      options: [
        {
          ...
          requiredState: currentState => currentState.isTailGunner,
          setState: {
            isMale: true,
            joinedAirForce: true,
            isTailGunner: true,
